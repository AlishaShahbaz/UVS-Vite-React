        ...
        <div className="pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-7 mb-8 md:mb-0 text-center md:text-left">
              <h1 style={{color:"#28BAB4"}} className=" lg:text-2xl font-extrabold" >Universal Vir<span style={{color:"#6460AB"}}>tual Support</span></h1>
              <h1 className="h1 lg:text-5xl mb-4 font-red-hat-display font-extrabold" data-aos="fade-down">Start Business with Our Company</h1>
              <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">We are the world’s most cost-effective English language-based outsourcing company and specialize in the management of customer care services and back office processes for global leaders in the domains of technical support, banking, telecom, transportation, and retail.</p>
              {/* CTA form */}
            ...
            <div className="md:col-span-5 lg:col-span-5 text-center md:text-right" data-aos="fade-up" data-aos-delay="450">
              <div className="inline-flex relative justify-center items-center">
                ...
                <img className="relative max-w-full mx-auto md:mr-0 md:max-w-none h-auto pointer-events-none" src={MockupImage} width="990" height="824" style={{ maxWidth: '70%' }} alt="Features illustration" />
                {/* iPhone mockup */}
                ...
                {/* <a className="absolute group" href="#0" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVideoModalOpen(true); }} aria-controls="modal">
                  <img src={PlayBtn} width="96" height="96" alt="Play" className='ml-4' />
                </a> */}
              </div>
