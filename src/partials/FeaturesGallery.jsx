...
import ChatBot from '../images/Startup Pic.png';
import CustomerCare from '../images/customer-care.jpg';
import OfficeDesk from '../images/ComputerOffice.jpg';
import OfficeWork2 from '../images/OfficeWork2.jpg';
import OrderBot from '../images/OrderBot2.jpg';
import CallRepresentative from '../images/Computer-Office2.jpg';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            {/* <p className="text-xl text-gray-600 dark:text-teal-500">About </p> */}
            <h2 className="h2 font-red-hat-display mb-4">About <span className="text-teal-500">Us</span> </h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
               ...
               <svg className="w-20 h-20 fill-current text-teal-500  mt-4 -ml-2" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Founded in 2019</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                ...
                <svg className="w-20 h-20 fill-current text-purple-500  mt-4 -ml-2" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">$10M+ Achieved</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                ...
                <svg className="w-20 h-20 fill-current text-indigo-500  mt-4 -ml-2" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">1000+ Websites</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              <div className="relative w-20 h-20 mb-3">
                ...
                <svg className="w-20 h-20 fill-current text-pink-500  mt-4 -ml-2" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-12 gap-3 mt-12 md:mt-20" data-aos-id-gallery>
            <img className="col-span-4" src={OfficeDesk} width="360" height="270" alt="About grid 01" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" />
            <img className="col-span-3 " src={ChatBot} width="270" height="270" alt="About grid 02" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="100" />
            <img className="col-span-5" src={OfficeWork2} width="450" height="48" alt="About grid 03" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="200" />
            <img className="col-span-3" src={CustomerCare} width="270" height="270" alt="About grid 04" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="300" />
            <img className="col-span-5" src={CallRepresentative} width="450" height="270" alt="About grid 05" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="400" />
            <img className="col-span-4" src={OrderBot} width="460" height="470" alt="About grid 06" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="500" />
          </div>
