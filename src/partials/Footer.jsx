    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
            ...
            <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
              ...
              <img src={MockupImage} style={{height:"160px",width:"160px",objectFit:"contain",margin:'0px'}}/>
            </Link>
                </div>
                ...
                <div className="md:col-span-10 lg:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    {/* 2nd block */}
                    <div className="text-sm lg:-ml-6 md:-ml-6">
                    ...
                    <h6 className="font-medium uppercase mb-2 ">Links</h6>
                        <ul className=''>
                            <li className="mb-1">
                            ...
                            <li className="mb-1">
                                <Link className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" to="/services">Services</Link>
                            </li>
                            {/* <li className="mb-1">
                                <Link className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" to="/blog">Blog</Link>
                            </li> */}
                            {/* <li className="mb-1">
                                <Link className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" to="/testimonial">Testimonial</Link>
                            </li> */}
                            <li className="mb-1">
                                <Link className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" to="/contact">Contact Us</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <h6 className="font-medium uppercase mb-2">Join us on our social media pages</h6>


                    <ul className="flex mb-4 md:order-2 md:ml-4 md:mb-0 mt-6">
                    <li>
                    ...
                    <li className="ml-4">
                        <a className="flex justify-center items-center text-white bg-teal-500 dark:text-teal-500 dark:bg-gray-800 hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out" href="https://www.facebook.com/people/Universal-Virtual-Support/100057196640100/" target={'_blank'} aria-label="Facebook">
                            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="md:flex md:items-center md:justify-between">
                ...
                <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">
                    <a href="https://universalvirtualsupport.com/">&copy; UniversalVirtualSupport.com. All rights reserved.</a>
                </div>
